...
insert into Orders(ORDER_ID,CUSTOMER_ID,PRODUCT_ID,QUANTITY,ORDER_DATE)values(1,1,1,1,"2025-07-01"),(2,4,2,1,"2025-07-15"),(3,3,1,2,"2025-07-15"),(4,3,1,1,"2025-08-1"),(5,5,2,1,"2025-08-2"),(6,1,1,1,"2025-08-5"),(7,4,1,3,"2025-06-1"),(8,5,1,1,"2024-06-1"),(9, 1, 3, 1, '2025-08-10'),(10, 2, 5, 2, '2025-08-12');
select * from Customers;
select*from Products;
select*from Orders;
# Order Management
# a) Retrieve all orders placed by a specific customer.
select C.Customer_ID,O.ORDER_ID,O.ORDER_DATE,P.PRODUCT_NAME,O.QUANTITY
from Customers C left join Orders O on C.CUSTOMER_ID=O.CUSTOMER_ID left join Products P on O.PRODUCT_ID=P.PRODUCT_ID 
where C.Customer_ID=1
group by C.Customer_ID,O.ORDER_ID,O.ORDER_DATE,P.PRODUCT_NAME,O.QUANTITY;
...
select C.NAME,C.CUSTOMER_ID,sum(O.QUANTITY*P.PRICE) as total_purchase_amount
